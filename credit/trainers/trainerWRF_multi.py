...
class Trainer(BaseTrainer):
    ...
    def train_one_epoch(self, epoch, conf, trainloader, optimizer, criterion, scaler, scheduler, metrics):
        ...
        static_dim_size = len(conf["data"]["dynamic_forcing_variables"]) + len(conf["data"]["forcing_variables"]) + len(conf["data"]["static_variables"]) + len(conf["data"]["boundary"]["variables"]) + len(conf["data"]["boundary"]["surface_variables"])

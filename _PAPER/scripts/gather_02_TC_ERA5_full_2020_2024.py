...
source_dir = f'/glade/derecho/scratch/ksha/DWC/RAW_OUTPUT/CONUS_TC_ERA5_final/{year_pred}*/*'

dt_start = f'{year_pred}-06-01T00'
dt_end = f'{year_pred}-11-30T23'

list_fn = sort_files(glob(source_dir))

list_ds = []
for fn in list_fn:
    list_ds.append(xr.open_dataset(fn))
...
ds_year['bottom_top'] = ds_example['bottom_top'].values
...
save_dir = f'/glade/derecho/scratch/ksha/DWC_data/CONUS_domain_TC/TC_pred/pred_ERA5_{year_pred}.zarr'

...
source_dir = f'/glade/derecho/scratch/ksha/DWC/RAW_OUTPUT/CONUS_TC_GDAS_final/{year_pred}*/*'
...
save_dir = f'/glade/derecho/scratch/ksha/DWC_data/CONUS_domain_TC/TC_pred/pred_GDAS_{year_pred}.zarr'
